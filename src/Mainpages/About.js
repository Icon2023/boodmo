  ...
  return (
    <div>
      <main className="main__content_wrapper">
              ...
              <div className="col-lg-6">
                <div className="about__thumb d-flex">
                  <div className="about__thumb--items">
                    <img
                      className="about__thumb--img border-radius-5"
              ...
              <div className="col">
                <div className="counterup__banner--inner position__relative d-flex align-items-center justify-content-between">
                  <div className="counterup__items text-center">
                    ...
                    <span
                      className="counterup__number js-counter"
                      data-count={50}
                    >
                      0
                    </span>
        ...
        <section className="testimonial__section testimonial__bg section--padding pt-0">
          <div className="container">
            <div className="section__heading style2 text-center mb-40">
            ...
            <div className="testimonial__section--inner">
              <div className="testimonial__active--one  swiper">
                <div className="swiper-wrapper">
                  ...
                  <div className="swiper-slide">
                    <div className="testimonial__items--thumbnail">
                      <img
                        className="testimonial__items--thumbnail__img"
                        src="assets/img/other/testimonial-thumb4.webp"
                        alt="testimonial-img"
                      />
                    </div>
                  </div>
                  <div className="swiper-slide">
                    <div className="testimonial__items--thumbnail">
                      <img
                        className="testimonial__items--thumbnail__img"
                        src="assets/img/other/testimonial-thumb5.webp"
                        alt="testimonial-img"
                      />
                    </div>
                  </div>
              ...
              <div className="testimonial__active--two swiper">
                <div className="swiper-wrapper">
                  <div className="swiper-slide">
        ...
        {/* Start brand section */}
        <div className="brand__section brand__section--style3 section--padding">
          <div className="container">
            <div className="brand__section--inner__style3 d-flex justify-content-between align-items-center">
