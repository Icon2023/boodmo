            ...
            >
                <Box className='model_support_box'>
                    <div className='d-flex justify-content-between'>
                        <h2 style={{ fontSize: "40px", color: '#363062' }}>Help & <span style={{ color: "#363062" }}>Support</span></h2>
                    ...
                    <div className='d-flex gap-5 flex-wrap'>
                        <div>
                            <div className='d-flex gap-3 mt-5'>
                                <div>
                                    <FaLocationArrow className='mt-1' style={{ fontSize: "30px", color: "#363062" }} />
                                </div>
                                <div>
                                    <h2 className='mb-3' style={{ color: "#363062" }}>Location</h2>
                                    <p>Autoholic Parts Online Pvt. Ltd. <br />
                            ...
                            <div className='d-flex gap-3 mt-5'>
                                <div>
                                    <MdLocalPhone className='mt-1' style={{ fontSize: "30px", color: "#363062" }} />
                                </div>
                                <div>
                                    <h2 className='mb-3' style={{ color: "#363062" }}>Phone</h2>
                                    <p>+91 98986 89569</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className='support_note'>
                        <h2>Note</h2>
                        <p className='mt-3'>For assistance, please reach out to our customer support team, available every day from 10:00 AM to 7:00 PM. You can contact us through the Help & Support Form on our website and application. You can also use our IVR number: +91 98986 89569 </p>
                        <p><span style={{ color: "red" }}>!WARNING!</span>  Do not call any other number except mentioned above. Please note, boodmo never calls & asks for bank account details, UPI id, OTP, etc. from the customer. We urge you not to share such information with anyone. In case of any fraudulent transaction, immediately notify your bank.</p>
